...
REPO='/home/exdata/istinye/mmpretrain'
EXP_DIR=/home/exdata/istinye/swin_t_training/swin_t_tiny_IN320_JAN_27/swin_t_tiny_IN320_JAN_27/swin_t_tiny_IN320_JAN_27
CHECKPOINT=best_accuracy_top1_epoch_49.pth
...
command='cd '$REPO'; CUDA_VISIBLE_DEVICES='$CUDA_VISIBLE_DEVICES' python3 tools/test.py '${CONFIG}' '$EXP_DIR'/'${CHECKPOINT}' --out  '$EXP_DIR'/'$OUT_DIR' --out-item pred --work-dir '$EXP_DIR'/'$METRICS_DIR' --show-dir '$EXP_DIR'/'$SHOW_DIR' --out '$EXP_DIR'/'$DET_RESULTS_FILENAME''
...
REPO='/home/exdata/istinye/mmpretrain'
EXP_DIR=/home/exdata/istinye/swin_t_training/pruned_swin_t_tiny_IN320_JAN_27/swin_t_tiny_IN320_JAN_27/pruned_swin_t_tiny_IN320_JAN_27
...
command='cd '$REPO'; CUDA_VISIBLE_DEVICES='$CUDA_VISIBLE_DEVICES' python3 tools/test.py '${CONFIG}' '$EXP_DIR'/'${CHECKPOINT}' --out  '$EXP_DIR'/'$OUT_DIR' --out-item pred --work-dir '$EXP_DIR'/'$METRICS_DIR' --show-dir '$EXP_DIR'/'$SHOW_DIR' --out '$EXP_DIR'/'$DET_RESULTS_FILENAME' --test-pruned-model'
screen -S $SCREEN_SESSION_NAME -L -Logfile $LOGFILE -dm bash -c "$command"
tail -f $LOGFILE 
...
REPO='/home/exdata/istinye/mmpretrain'
EXP_DIR=/home/exdata/istinye/swin_t_training/pruned_50_swin_t_tiny_IN320_JAN_27/pruned_50_swin_t_tiny_IN320_JAN_27/pruned_50_swin_t_tiny_IN320_JAN_27
CHECKPOINT='dummy.pth'
CONFIG=configs/swin_transformer/swin-tiny_1xb256_in1k_224_1k.py
CUDA_VISIBLE_DEVICES=0
...
command='cd '$REPO'; CUDA_VISIBLE_DEVICES='$CUDA_VISIBLE_DEVICES' python3 tools/test.py '${CONFIG}' '${CHECKPOINT}' --out  '$EXP_DIR'/'$OUT_DIR' --out-item pred --work-dir '$EXP_DIR'/'$METRICS_DIR' --show-dir '$EXP_DIR'/'$SHOW_DIR' --out '$EXP_DIR'/'$DET_RESULTS_FILENAME' --test-pruned-model'
screen -S $SCREEN_SESSION_NAME -L -Logfile $LOGFILE -dm bash -c "$command"
tail -f $LOGFILE 
...
# test original unpruned model
REPO='/home/exdata/istinye/mmpretrain'
EXP_DIR=/home/exdata/istinye/swin_t_training/swin_t_tiny_in200/chkpnt
...
REPO='/home/exdata/istinye/mmpretrain'
EXP_DIR=/home/exdata/istinye/swin_t_training/pruned_swin_t_tiny_in200/chkpnt
CHECKPOINT='dummy.pth'
CONFIG=configs/swin_transformer/swin-tiny_1xb256_in1k_224_1k.py
CUDA_VISIBLE_DEVICES=0
METRICS_DIR=metrics_pruned
