...
GPU=0
LOGFILE=LOG.swin_t_tiny_in200
SCREEN_SESSION_NAME=swin_t_tiny_in200
EXP_ROOT_DIR=/mnt/disks/ext/exps_swin_t/swin_t_tiny_in200
WORK_DIR_NAME=swin_t_tiny_in200
command='cd $REPO_MMDETECTION_ROOT; PORT=29503 CUDA_VISIBLE_DEVICES='$GPU' python ./tools/train.py '$CONFIG' --work-dir '$EXP_ROOT_DIR'/swin_t_tiny_in200/'$WORK_DIR_NAME''
